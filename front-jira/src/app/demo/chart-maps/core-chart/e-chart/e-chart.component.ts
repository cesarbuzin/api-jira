...
export class EChartComponent implements OnInit {
  // private Props
  lineBasicOption!: object;
  lineAreaOption!: object;
  barBasicColumnOption!: object;
  barBasicBarOption!: object;
  pieBasicColumnOption!: object;
  pieDoughnutOption!: object;
  pieTimelineOption!: object;
  gaugeOption!: object;
  ...
  ngOnInit() {
    ...
    this.lineAreaOption = {
      ...
      color: ['rgba(33, 150, 243, 0.5)', 'rgba(103, 58, 183, 0.5)', 'rgba(32, 201, 151, 0.5)'],
      yAxis: [
        {
          type: 'value',
          splitLine: {
    ...
    this.barBasicColumnOption = {
      ...
      calculable: true,
      color: ['rgba(33, 150, 243, 1)', 'rgba(103, 58, 183, 1)'],
      xAxis: [
        {
          type: 'category',
          boundaryGap: false,
    ...
    this.pieBasicColumnOption = {
      ...
      color: ['#ffc107', '#A389D4', '#3ebfea', '#2196f3', '#673ab7'],
      toolbox: {
        show: true,
        feature: {
          mark: {
